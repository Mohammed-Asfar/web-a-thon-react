        ...
        <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
          <div
            ...
            <h2
              ...
              {subtitle.regular}
              <span
                className="text-transparent bg-clip-text bg-gradient-to-r from-[#c101fb] to-[#4a2371]">
                {subtitle.gradient}
              </span>
            </h2>
            ...
            <div
              ...
              <span className="relative inline-block overflow-hidden rounded-full p-[1.5px]">
                <span
                  className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#c101fb_0%,#4a2371_50%,#c101fb_100%)]" />
                <div
                  ...
                  {onCtaClick ? (
                    <button
                      onClick={onCtaClick}
                      className="inline-flex rounded-full text-center group items-center w-full justify-center bg-gradient-to-tr from-[#c101fb]/20 via-[#4a2371]/30 to-transparent text-white border-[#c101fb]/50 border-[1px] hover:bg-gradient-to-tr hover:from-[#c101fb]/30 hover:via-[#4a2371]/40 hover:to-transparent transition-all sm:w-auto py-4 px-10">
                      {ctaText}
                    </button>
                  ) : (
                    <a
